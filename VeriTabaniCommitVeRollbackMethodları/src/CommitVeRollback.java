    ...
    */
    ...
    public void commitverollback() {
        ...
        try {
            ...
            String sorgu2 = "Update calisanlar set email = 'coskun.m.murat@gmail.com' where id = 2";
            
            System.out.println("Güncellenmeden Önce");
            
            /*
             * calisanlariGetir methodunda herhangi bir güncelleme islemi yapmayip sadece sorgu yaptığımız için
             * autoCommit false olsa bile "sorgu" oldugundan dolayı calisacak. Eger bir güncelleme islemi iceren
             * statement yazsaydık bu biz "commit" edene kadar calismazdi.
             */
    ...
    public static void main(String[] args) {
		CommitVeRollback rollback = new CommitVeRollback();
		
		rollback.commitverollback();
